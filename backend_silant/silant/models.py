...
class Car(models.Model):
    ...
    transmission = models.ForeignKey(TransmissionModel, on_delete=models.CASCADE, verbose_name='Модель трансмиссии')
    transmission_no = models.CharField(max_length=100, verbose_name='Зав. № трансмиссии')
    leading_axle = models.ForeignKey(LeadingAxle, on_delete=models.CASCADE, verbose_name='Модель ведущего моста')
    leading_axle_no = models.CharField(max_length=100, verbose_name='Зав. № ведущего моста')
    controlled_axle = models.ForeignKey(ControlledAxle, on_delete=models.CASCADE, verbose_name='Модель управляемого моста')
